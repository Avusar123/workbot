...
//import com.workbot.workbot.telegram.newapi.setup.redis.DataRepo;
...
//
//    @Autowired
//    private DataRepo pendingDataRepo;
//
...
//            processStateMachine(pendingDataRepo.get(userId, messageId), event.getUpdate(), userId, messageId);
//        }
//    }
//
//    @EventListener
...
//        }
//
//        pendingDataRepo.save(userId, messageId, model);
//    }
//}
